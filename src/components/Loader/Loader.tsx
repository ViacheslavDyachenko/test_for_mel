...
class Loader extends React.Component<IProps> {
    ...
    render(): React.ReactNode {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" style={{margin: 'auto', background: 'rgba(255, 255, 255, 0)', display: `${this.props.style}`}} width={this.props.width} height={this.props.height} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                <g transform="rotate(0 50 50)">
                <rect x="48.5" y="1.5" rx="1.5" ry="10.5" width="3" height="21" fill="#000000">
